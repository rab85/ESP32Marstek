...
void DisplayInfo() {
  ...
  display.println("Percentage: " + String((batteryPercentage*BatteryCapacity)/100) + " W");
  display.println("Percentage: " + String(batteryPercentage) + " W");
